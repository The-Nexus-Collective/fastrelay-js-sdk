...
```bash
npm install fastrelay-feed-sdk
```

## Quick start

```ts
import { FastrelayClient } from 'fastrelay-feed-sdk';
...
```ts
import { FeedPollingService } from 'fastrelay-feed-sdk';
...
```ts
import { uploadVideoBytes } from 'fastrelay-feed-sdk';
...
```ts
import { FastrelayApiError } from 'fastrelay-feed-sdk';
